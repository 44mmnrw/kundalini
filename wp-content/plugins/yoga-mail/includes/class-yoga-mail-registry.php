...
final class Yoga_Mail_Registry {
	...
	public function values(string $id): ?array {
		...
		$values = wp_parse_args($custom, $definition['defaults']);
		if ($id === 'support-autoreply') {
		...
		if ($id === 'sadhana-completed') {
			$values['body'] = str_replace(
				array(
					'width="214" align="center" valign="middle" bgcolor="#f6f6f9" style="width:50%;',
					'width="12" style="width:12px;padding:0;font-size:1px;line-height:1px;"',
				),
				array(
					'width="48%" align="center" valign="middle" bgcolor="#f6f6f9" style="width:48%;',
					'width="4%" style="width:4%;padding:0;font-size:1px;line-height:1px;"',
				),
				(string) $values['body']
			);
		}
		...
		$definitions = array(
			...
			'payment-success-receipt' => array(
				...
				'defaults' => array(
					...
					'body' => '<p style="margin:0;line-height:1.5;font-weight:400;text-align:center;">Ваш чек о приобретении подписки ниже.</p><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;margin:30px 0 0;border-collapse:separate;background-color:#ffffff;border:1px solid #dedee1;border-radius:15px;"><tr><td style="padding:20px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;"><tr><td valign="middle" style="padding:0 10px 15px 0;font-size:16px;line-height:1.5;font-weight:700;color:#1f1f1f;text-align:left;">Чек №{{receipt_number}}</td><td valign="middle" align="right" style="padding:0 0 15px 10px;font-size:16px;line-height:1.5;font-weight:700;color:#1f1f1f;text-align:right;white-space:nowrap;">{{payment_date}}</td></tr><tr><td colspan="2" height="1" bgcolor="#dedee1" style="height:1px;font-size:1px;line-height:1px;background-color:#dedee1;">&nbsp;</td></tr>{{receipt_items}}<tr><td colspan="2" height="1" bgcolor="#dedee1" style="height:1px;font-size:1px;line-height:1px;background-color:#dedee1;">&nbsp;</td></tr><tr><td valign="middle" style="padding:15px 10px 0 0;font-size:16px;line-height:1.5;font-weight:700;color:#1f1f1f;text-align:left;">Итого оплачено</td><td valign="middle" align="right" style="padding:15px 0 0 10px;font-size:16px;line-height:1.5;font-weight:700;color:#1f1f1f;text-align:right;white-space:nowrap;">{{total_amount}}</td></tr><tr><td valign="middle" style="padding:15px 10px 0 0;font-size:16px;line-height:1.5;font-weight:400;color:#606060;text-align:left;">Способ оплаты</td><td valign="middle" align="right" style="padding:15px 0 0 10px;font-size:16px;line-height:1.5;font-weight:400;color:#606060;text-align:right;white-space:nowrap;">{{payment_method}}</td></tr></table></td></tr></table>',
			...
			'question-answer' => array(
				...
				'defaults' => array(
					...
					'body' => '<p style="margin:0;line-height:1.5;font-weight:400;text-align:center;"><strong style="font-weight:700;">Администратор</strong> ответил на ваш вопрос в личных сообщениях <strong style="font-weight:700;">{{answer_datetime}} по МСК.</strong></p><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;margin:30px 0 0;border-collapse:separate;background-color:#f7f3fd;border-radius:15px 15px 15px 0;"><tr><td align="left" bgcolor="#f7f3fd" style="padding:20px;background-color:#f7f3fd;border-radius:15px 15px 15px 0;font-family:Mulish,Helvetica,Arial,sans-serif;font-size:16px;line-height:1.5;font-weight:400;color:#1f1f1f;text-align:left;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:separate;"><tr><td align="center" bgcolor="#9153e1" style="padding:6px 10px;background-color:#9153e1;border-radius:30px;font-family:Mulish,Helvetica,Arial,sans-serif;font-size:12px;line-height:1;font-weight:700;color:#ffffff;text-align:center;text-transform:uppercase;white-space:nowrap;">Администратор</td></tr></table><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;"><tr><td align="left" style="padding:15px 0 0;font-family:Mulish,Helvetica,Arial,sans-serif;font-size:16px;line-height:1.5;font-weight:400;color:#1f1f1f;text-align:left;">{{admin_answer}}</td></tr></table></td></tr></table>',
			...
			'comment-reply' => array(
				...
				'defaults' => array(
					...
					'body' => '<p style="margin:0;line-height:1.5;font-weight:400;text-align:center;"><strong style="font-weight:700;">{{reply_author}}</strong> ответил(а) на ваш комментарий к практике <strong style="font-weight:700;">«{{practice_title}}» {{reply_datetime}} по МСК.</strong></p><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;margin:30px 0 0;border-collapse:separate;background-color:#f6f6f9;border-radius:15px 15px 15px 0;"><tr><td bgcolor="#f6f6f9" style="padding:20px 75px 20px 20px;background-color:#f6f6f9;border-radius:15px 15px 15px 0;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;"><tr><td width="40" valign="top" style="width:40px;padding:0;">{{reply_avatar}}</td><td class="yoga-mail-comment-gap" width="15" style="width:15px;padding:0;font-size:1px;line-height:1px;">&nbsp;</td><td width="330" valign="top" style="width:330px;padding:0;text-align:left;"><p style="margin:0;font-size:16px;line-height:1;font-weight:700;color:#1f1f1f;text-align:left;">{{reply_author}}</p><p style="margin:10px 0 0;font-size:16px;line-height:1.5;font-weight:400;color:#1f1f1f;text-align:left;">{{reply_content}}</p></td></tr></table></td></tr></table>',
			...
			'sadhana-completed' => array(
				...
				'defaults' => array(
					...
					'heading' => '',
					'body' => '<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto;border-collapse:separate;"><tr><td align="center" bgcolor="#e8ff57" style="padding:8px 14px;background-color:#e8ff57;border-radius:500px;font-family:Mulish,Helvetica,Arial,sans-serif;font-size:16px;line-height:1;font-weight:700;color:#1f1f1f;text-align:center;text-transform:uppercase;white-space:nowrap;">Садхана пройдена</td></tr></table><h1 style="margin:15px 0 0;font-family:Mulish,Helvetica,Arial,sans-serif;font-size:22px;line-height:1;font-weight:700;color:#1f1f1f;text-align:center;">Сат Нам, {{user_name}}! Вы прошли всю Садхану</h1><p style="margin:15px 0 0;line-height:1;font-weight:700;text-align:center;">Сат Нам, {{user_name}}!</p><p style="margin:15px 0 0;line-height:1.5;font-weight:400;text-align:center;">Все <strong style="font-weight:700;color:#9153e1;">{{target_days}}</strong> {{target_day_label}} садханы <strong style="font-weight:700;color:#9153e1;">«{{practice_title}}»</strong> пройдены.<br>Вы начали <strong style="font-weight:700;color:#9153e1;">{{started_date}} и дошли до конца</strong> — это большое достижение и настоящая трансформация.</p><table role="presentation" width="440" cellpadding="0" cellspacing="0" border="0" align="center" style="width:100%;max-width:440px;margin:30px auto 0;border-collapse:separate;"><tr><td width="48%" align="center" valign="middle" bgcolor="#f6f6f9" style="width:48%;padding:16px;background-color:#f6f6f9;border-radius:15px;text-align:center;"><p style="margin:0;font-family:Mulish,Helvetica,Arial,sans-serif;font-size:22px;line-height:1;font-weight:700;color:#9153e1;text-align:center;">{{target_days}}</p><p style="margin:4px 0 0;font-family:Mulish,Helvetica,Arial,sans-serif;font-size:12px;line-height:1;font-weight:400;color:#606060;text-align:center;">{{target_day_label}} подряд</p></td><td width="4%" style="width:4%;padding:0;font-size:1px;line-height:1px;">&nbsp;</td><td width="48%" align="center" valign="middle" bgcolor="#f6f6f9" style="width:48%;padding:16px;background-color:#f6f6f9;border-radius:15px;text-align:center;"><p style="margin:0;font-family:Mulish,Helvetica,Arial,sans-serif;font-size:22px;line-height:1;font-weight:700;color:#9153e1;text-align:center;">100%</p><p style="margin:4px 0 0;font-family:Mulish,Helvetica,Arial,sans-serif;font-size:12px;line-height:1;font-weight:400;color:#606060;text-align:center;">садхана пройдена</p></td></tr></table>',
