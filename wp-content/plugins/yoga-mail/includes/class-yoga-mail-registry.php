		...
		$definitions = array(
			...
			'question-answer' => array(
				...
				'defaults' => array(
					...
					'body' => '<p style="margin:0;line-height:1.5;font-weight:400;text-align:center;"><strong style="font-weight:700;">Администратор</strong> ответил на ваш вопрос в личных сообщениях <strong style="font-weight:700;">{{answer_datetime}} по МСК.</strong></p><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;margin:30px 0 0;border-collapse:separate;background-color:#f7f3fd;border-radius:15px 15px 15px 0;"><tr><td align="left" bgcolor="#f7f3fd" style="padding:20px;background-color:#f7f3fd;border-radius:15px 15px 15px 0;font-family:\'Mulish\',Arial,Helvetica,sans-serif;font-size:14px;line-height:1.5;font-weight:400;color:#1f1f1f;text-align:left;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:separate;"><tr><td align="center" bgcolor="#9153e1" style="padding:6px 10px;background-color:#9153e1;border-radius:30px;font-family:\'Mulish\',Arial,Helvetica,sans-serif;font-size:12px;line-height:1;font-weight:700;color:#ffffff;text-align:center;text-transform:uppercase;white-space:nowrap;">Администратор</td></tr></table><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;"><tr><td align="left" style="padding:15px 0 0;font-family:\'Mulish\',Arial,Helvetica,sans-serif;font-size:14px;line-height:1.5;font-weight:400;color:#1f1f1f;text-align:left;">{{admin_answer}}</td></tr></table></td></tr></table>',
