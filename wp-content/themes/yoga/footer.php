...
<section class="home-footer-subscribe" aria-labelledby="home-footer-subscribe-title">
	...
	<form class="footer-subscribe home-footer-subscribe__form" action="<?php echo esc_url(home_url('/')); ?>" method="post">
		...
		<label class="footer-subscribe__agree"><input class="footer-subscribe__checkbox" type="checkbox" name="footer_subscribe_agree" aria-required="true"><svg class="footer-subscribe__check-icon" aria-hidden="true" focusable="false"><use href="<?php echo esc_url(get_template_directory_uri() . '/assets/svg/sprite.svg#tariff-check'); ?>"></use></svg><span>Я соглашаюсь на <a href="<?php echo esc_url(($footer_legal_links[3]['url'] ?? '') ?: $footer_privacy_url ?: home_url('/')); ?>">обработку персональных данных</a> и получение рассылок</span></label>
				...
				<?php if (!$is_home_footer) : ?><form class="footer-subscribe" action="<?php echo esc_url(home_url('/')); ?>" method="post">
					...
					<div class="footer-subscribe__main">
						...
						<div class="footer-subscribe__field">
							...
							<span class="footer-subscribe__tooltip" id="footer-subscribe-consent-tooltip" role="alert" hidden>Подтвердите согласие на обработку персональных данных и получение рассылок.</span>
						</div>
					</div>
					<label class="footer-subscribe__agree">
						<input class="footer-subscribe__checkbox" type="checkbox" name="footer_subscribe_agree" aria-required="true">
						<svg class="footer-subscribe__check-icon" aria-hidden="true" focusable="false">
							<use href="<?php echo esc_url(get_template_directory_uri() . '/assets/svg/sprite.svg#tariff-check'); ?>"></use>
						</svg>
						<span>
							Я соглашаюсь на
