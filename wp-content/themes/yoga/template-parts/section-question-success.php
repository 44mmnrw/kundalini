    ...
    <div class="container">
        <div class="question-success">
            <div class="question-success__decor question-success__decor--oval" aria-hidden="true">
                <svg viewBox="0 0 58 115" focusable="false"><use href="<?php echo $sprite_url; ?>#contacts-decor-oval"></use></svg>
            </div>
            ...
            <div class="question-success__envelope" aria-hidden="true">
                <svg viewBox="0 0 48 48" focusable="false"><use href="<?php echo $sprite_url; ?>#contacts-form-badge"></use></svg>
            </div>
            ...
            <div class="question-success__content">
                ...
                <a class="question-success__button btn" href="<?php echo esc_url($contacts_url); ?>#section-form-questions">Спросить ещё</a>
            </div>
        </div>
    </div>
</section>
